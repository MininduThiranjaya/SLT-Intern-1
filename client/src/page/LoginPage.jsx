          ...
          <div className="flex items-center gap-3 mb-9">
            <div
              className="w-12 h-12 bg-yellow-400 rounded-2xl 
                        ...
                        shadow-[0_4px_18px_rgba(251,191,36,0.5)]"
            >
            ...
            <div>
              ...
              <div
                className="text-[0.68rem] text-yellow-400 
                          tracking-[0.1em] uppercase mt-0.5"
              >
                Bus Seat Booking
              </div>
            </div>
          ...
          <form onSubmit={handleSubmit}>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-4 top-1/2 -translate-y-1/2 
                         text-[#9a9eb8] hover:text-yellow-400 transition"
                >
            ...
            <div className="flex justify-center mt-2 mb-6">
              <a
                ...
                className="text-sm text-yellow-500 hover:opacity-75 transition"
              >
                Forgot password?
              </a>
            </div>
            ...
            >
              {status === "loading" ? (
                <>
                  <span
                    className="w-4 h-4 border-2 border-[#0d0f1a] 
